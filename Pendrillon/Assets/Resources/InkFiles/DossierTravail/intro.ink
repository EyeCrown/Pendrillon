...
- (choose_archetype) Choisissez votre archétype.
    ...
    + [Beau Parleur]
        Le <shake>Beau Parleur</shake> sait manier les mots et faire preuve de charisme. #anim:Player:charisma_archetype
    ...
    + [Force de la Nature]
        La <shake>Force de la Nature</shake> sait manier les poings et faire trembler ses détracteurs. #anim:Player:strength_archetype
    ...
    + [Acrobate]
        L'<shake>Acrobate</shake> sait se montrer agile et faire preuve d'adresse. #anim:Player:dexterity_archetype
